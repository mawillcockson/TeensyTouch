...
int gpin23;
void loop() {
    #define reps (100) // Number of repititions for the timing loops
    ...
    // As local variables (speedy) [not actually speedy]
    //start_time = micros();
    //for (uint16_t count = 0; count < reps; ++count) {
        //pin0 = touchValNowIS(0);
        //pin1 = touchValNowIS(1);
        //pin15 = touchValNowIS(15);
        //pin16 = touchValNowIS(16);
        //pin17 = touchValNowIS(17);
        //pin18 = touchValNowIS(18);
        //pin19 = touchValNowIS(19);
        //pin22 = touchValNowIS(22);
        //pin23 = touchValNowIS(23);
    //}
    //end_time = micros();
    //unsigned long local_loop_time_speedy = (end_time - start_time);
    ...
    // As global variables (speedy)
    //start_time = micros();
    //for (uint16_t count = 0; count < reps; ++count) {
        //gpin0 = touchValNowIS(0);
        //gpin1 = touchValNowIS(1);
        //gpin15 = touchValNowIS(15);
        //gpin16 = touchValNowIS(16);
        //gpin17 = touchValNowIS(17);
        //gpin18 = touchValNowIS(18);
        //gpin19 = touchValNowIS(19);
        //gpin22 = touchValNowIS(22);
        //gpin23 = touchValNowIS(23);
    //}
    //end_time = micros();
    //unsigned long global_loop_time_speedy = (end_time - start_time);
    ...
    //Sp("Local var loop (speedy):  ");Sp(local_loop_time_speedy/float(reps));Sp("  ");Spn((local_loop_time_speedy - blank_loop_time)/float(reps));
    Sp("Global var loop:          ");Sp(global_loop_time/float(reps));Sp("  ");;Spn((global_loop_time - blank_loop_time)/float(reps));
    //Sp("Global var loop (speedy): ");Sp(global_loop_time_speedy/float(reps));Sp("  ");;Spn((global_loop_time_speedy - blank_loop_time)/float(reps));
